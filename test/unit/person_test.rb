...
class PersonTest < ActiveSupport::TestCase
  ...
  test "person has a home_church property" do
    ...
    assert(Person.respond_to?('home_church'), "Person does not have a home_church property (has the relationship been set up correctly?)")
  end
  ...
  test "person has a field_ministry_involvements property" do
    assert(Person.respond_to?('field_ministry_involvements'), "Person does not have a field_ministry_involvements property (has the relationship been set up correctly?).")  
  end
